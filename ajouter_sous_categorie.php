...
if(isset($_POST['ajout_cat'])){
	$des=$_POST['des'];
        $id_cat=$_GET['cat'];
	$insert=$bdd->prepare("INSERT into sous_categorie(designation,id_categorie)VALUES('$des',$id_cat)");
	if($insert->execute()){
		?>

<script type="text/javascript">
	alert('la sous categorie est ajoutée!');
	window.location.href='gestion_categorie.php';
</script>
		...
		<?php
                ...
                <center><form method="POST" >
                	<label><strong style="font-size:25px;">Designation: </strong></label><br><br><input style="padding:10px; border-radius:10px; outline:none;" type="text" name="des"><br><br>
                	<input class="btn_commande" type="submit" name="ajout_cat" value="ajouter la sous categorie">
                </form>
                </center>
                </div>
                </body>
