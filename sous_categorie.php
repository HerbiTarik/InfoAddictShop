...
<a  href="ajouter_sous_categorie.php?cat=<?php echo $_GET['cat'];?>" style="margin-top: 250px;"><button class="btn_commande">ajouter une sous categorie</button></a>
<br><br>
<table border="1px" width="60%">
	<tr style="background: gray;" ><td><center><strong style="color:#fff;">nom de la sous categorie</strong></center></td></tr>
<?php 
$cat=$_GET['cat'];
$cat=$bdd->prepare("SELECT * FROM sous_categorie where id_categorie=$cat");
$cat->execute();
while($ct=$cat->fetch()){

?>
<tr><td><?php echo $ct['designation'];?></td>
