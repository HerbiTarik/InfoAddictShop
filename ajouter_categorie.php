...
if(isset($_POST['ajout_cat'])){
	$des=$_POST['des'];
	$insert=$bdd->prepare("INSERT into categorie(designation)VALUES('$des')");
	if($insert->execute()){
		?>

<script type="text/javascript">
	alert('la categorie est ajoutée!');
...
<ul>
         ...
         <li><a class="n-link" href="ajouter_categorie.php">ajouter une categorie</a></li>  
                ...
                <center>
                <form method="POST" >
                	<input style="padding:10px; border-radius:10px; outline:none;" type="text" name="des"><br><br>
                	<input class="btn_commande" type="submit" name="ajout_cat" value="ajouter la categorie">
                </form>
                </center>
                </div>
                </body>
