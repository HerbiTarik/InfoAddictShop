...
<table border="1px" width="60%">
	<tr style="background: gray;"><td><center><strong style="color:#fff;">nom de la categorie</strong></center></td><td><center><strong style="color:#fff;">les sous catégories</strong></center></td></tr>
<?php 
...
<td><a href="sous_categorie.php?cat=<?php echo $ct['id_categorie'];?>">voir ses sous categories</a></td>
</tr>
